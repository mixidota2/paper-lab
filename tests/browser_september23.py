...
from test_september23_labs import ALL_SLUGS as SLUGS
def main():
  ...
  for width in [360,390,768,1440]:
   ...
   for s in slugs:
    ...
    if width in [360,1440]:
     page.screenshot(path=f'/tmp/lab-sep23/{s}-{width}.png',full_page=True)
     page.locator('figure').first.screenshot(path=f'/tmp/lab-sep23/{s}-figure-{width}.png')
